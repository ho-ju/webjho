...
var span='<span id="'+id+'" class="jstar_span '+jstar_id+'" style="display:block; width:27px; height:27px; background:url('+jstar_image.src+') no-repeat '+bg_pos+'; margin:0; padding:0; position:absolute; top:-50px; left:0; pointer-events: none;">&nbsp;</span>';$(document.body).append(span);var star=$('#'+id);star.css({top:y,left:x,'opacity':opacity}).animate({opacity:0},settings.delay,function(){star.remove()})})})};function jstar_rand(from,to){var r=Math.random();r=r*(to-from);r=r+from;r=Math.round(r);return r}
$.fn.jstars.defaults={image_path:'',image:'jstar-modern.png',style:'white',frequency:12,style_map:{white:0,blue:-25,green:-50,red:-75,yellow:-100},width:25,height:25,delay:500}})(jQuery)